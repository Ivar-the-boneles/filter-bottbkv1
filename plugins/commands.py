    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/Nonofcomedychannel"),
                    InlineKeyboardButton("Support Group", url="https://t.me/Nonofcomedychannel")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="Ivar-the-boneles/Autofilterbotv1")
                ],
                [
